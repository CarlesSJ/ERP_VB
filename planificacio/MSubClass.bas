...
'
' Modificado para usar con la clase CWndSubClass                    (21/Mar/99)
'
...
Private mWSC() As cWndSubclass          ' Array de clases
...
Public Function WndProc(ByVal hWnd As Long, ByVal uMSG As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    '   Dim WithEvents laClase As CWndSubClass
    '
    Static i As Long
...
Public Sub Hook(ByVal WSC As cWndSubclass, ByVal unControl As Object)
...
Public Sub unHook(ByVal WSC As cWndSubclass)
