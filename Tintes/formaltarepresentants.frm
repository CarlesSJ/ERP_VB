...
Private Sub Form_Resize()
  DBGrid1.Width = formaltarep.Width - 420
  Frame1.Width = DBGrid1.Width
   sortir.Left = Frame1.Width - sortir.Width - 75
...
Sub alta_registre()
 If DBGrid1.AllowUpdate = False Then
      ...
      DBGrid1.AllowUpdate = True
      If alta.Tag <> "" Then
         Data1.Recordset.Fields(alta.Tag) = alta.HelpContextID
      End If
...
Private Sub eliminar_Click()
 On Error GoTo err
 If hiharelacions Then MsgBox "Aquest registre ja te relacions. No es pot eliminar": Exit Sub
...
End Sub
Function hiharelacions() As Boolean
   Dim rst As Recordset
   If Data1.Tag = "" Then Exit Function
   Set rst = Data1.Database.OpenRecordset(Data1.Tag + atrim(Data1.Recordset!codi))
