...
Set rsttmp = dbtmp.OpenRecordset("select impressora,lotmatdesb1,lotmatdesb2,espessor,tubolam,mesuraesp from comandes where comanda=" + atrim(cadbl(Form1.comanda)))
  If Not rsttmp.EOF Then
   If cadbl(lotdesb1) = 0 Then
      lotdesb1.Text = cadbl(rsttmp!lotmatdesb1)
      lotdesb2.Text = cadbl(rsttmp!lotmatdesb2)
      emplenar_dades_capcalera
   End If
  End If
   Set rsttmp = Nothing
...
Sub emplenar_dades_capcalera()
 ...
 capcalera.Recordset!matdesb1 = possar_desc_lot2(cadbl(lotdesb1.Text), lot1, lot2)
 capcalera.Recordset!amplada1 = r
 ...
 If lot2 > 0 Then
  ...
  If Not rs2.EOF Then
    ...
    capcalera.Recordset!matdesb1 = capcalera.Recordset!matdesb1 + " + " + possar_desc_lot2(cadbl(lot2), lot1, lot2)
  End If
 End If
 ...
 capcalera.Recordset!matdesb2 = possar_desc_lot2(cadbl(lotdesb2.Text), lot1, lot2)
 capcalera.Recordset!amplada2 = r
 ...
 If lot2 > 0 Then
  ...
  If Not rs2.EOF Then
     ...
     capcalera.Recordset!matdesb2 = capcalera.Recordset!matdesb2 + " + " + possar_desc_lot2(cadbl(lot2), lot1, lot2)
  End If
 End If
 ...
 Function material_comanda(comanda As String)
  ...
  If Not rststocks.EOF Then
   ...
   If Not rs2.EOF Then rr = rs2!Nomfam
     Else: MsgBox "No hi ha bobines asignades a la comanda " + lotdesb2.Text: Exit Function
  End If
 Set rs2 = Nothing
 material_comanda = rr
 End Function
 Function possar_desc_lot(numlot As String, ByRef lot1 As Double, ByRef lot2 As Double) As String
  ...
  If Not rsttmp3.EOF Then
     ...
     If Not rsttmp2.EOF Then
       ...
       If Not rsttmp2.EOF Then possar_desc_lot = atrim(rsttmp2!descripcio)
     End If
  End If
  r = material_comanda(atrim(lot1))
  r = rststocks!ample
  ...
  If lot2 > 0 And proces = 2 Then
    ...
    If Not rsttmp3.EOF Then
     ...
     If Not rsttmp2.EOF Then
       Set rsttmp2 = dbtmp.OpenRecordset("select descripcio from familiesmaterials where codi=" + atrim(cadbl(rsttmp2!familia)))
       If Not rsttmp2.EOF Then possar_desc_lot = atrim(possar_desc_lot) + " + " + atrim(rsttmp2!descripcio)
     End If
    End If
    r = material_comanda(atrim(lot2))
    If cadbl(rststocks!ample) > cadbl(r) Then r = cadbl(rststocks!ample)
  End If
  Set rsttmp2 = Nothing
  Set rsttmp3 = Nothing
End Function
Function possar_desc_lot2(numlot As String, ByRef lot1 As Double, ByRef lot2 As Double) As String
  ...
  If rsttmp3.EOF Then possar_desc_lot2 = "": Exit Function
    ...
    If Not rsttmp3.EOF Then
     ...
     If Not rsttmp2.EOF Then
       Set rsttmp2 = dbtmp.OpenRecordset("select descripcio from familiesmaterials where codi=" + atrim(cadbl(rsttmp2!familia)))
       If Not rsttmp2.EOF Then possar_desc_lot2 = atrim(rsttmp2!descripcio)
     End If
    End If
