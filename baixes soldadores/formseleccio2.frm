...
Begin VB.Form formseleccio2 
   ...
   Begin VB.CommandButton bsensebossa 
      BackColor       =   &H0000FFFF&
      Caption         =   "Sense Bossa"
      BeginProperty Font 
         Name            =   "Arial Black"
   ...
   Begin VB.CommandButton Command3 
      Height          =   810
      Left            =   8985
      Picture         =   "formseleccio2.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   570
      Width           =   855
   ...
   Begin MSDBGrid.DBGrid DBGrid2 
      Bindings        =   "formseleccio2.frx":27E6
      Height          =   5835
      Left            =   90
      OleObjectBlob   =   "formseleccio2.frx":27F6
      TabIndex        =   0
      Top             =   225
      Width           =   8805
   End
   ...
   End
End
Attribute VB_Name = "formseleccio2"
...
If formseleccio2.tag = "1" Then DBGrid2.Columns(0).width = 0
Exit Sub
esperar3segons:
  wait (1)
  Resume
...
If bsensebossa.visible Then Me.Height = 7515
DBGrid2.col = 1
DBGrid2.SetFocus
DoEvents
...
Command3.Left = Me.width - (Command3.width * 1.4)
Command1.Left = Me.width - (Command1.width * 1.4)
End Sub
