...
Begin VB.Form formaltaformapag 
   ClientHeight    =   6090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "formaltaformapag.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   ScaleHeight     =   6090
   ScaleWidth      =   4680
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "formaltaformapag.frx":0442
      Height          =   5340
      Left            =   75
      Negotiate       =   -1  'True
      OleObjectBlob   =   "formaltaformapag.frx":0452
      TabIndex        =   6
      TabStop         =   0   'False
      Top             =   600
      Width           =   4515
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton alta 
         Height          =   360
         Left            =   75
         Picture         =   "formaltaformapag.frx":0E00
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton eliminar 
         Height          =   360
         Left            =   975
         Picture         =   "formaltaformapag.frx":1232
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton modificar 
         Height          =   360
         Left            =   525
         Picture         =   "formaltaformapag.frx":1544
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton sortir 
         Height          =   390
         Left            =   4050
         Picture         =   "formaltaformapag.frx":1892
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Alta  Registres"
         Top             =   150
      ...
      Begin VB.CommandButton Command1 
         Height          =   390
         Left            =   3600
         Picture         =   "formaltaformapag.frx":1D94
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   150
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "formaltaformapag"
...
Sub refrescar()
 ...
 For i = 0 To 50
   ...
   DBGrid1.Columns(i).Width = grandato * 125
