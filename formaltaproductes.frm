...
Begin VB.Form formaltaproductes 
   ClientHeight    =   6090
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5445
   Icon            =   "formaltaproductes.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   ScaleHeight     =   6090
   ScaleWidth      =   5445
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "formaltaproductes.frx":0442
      Height          =   5340
      Left            =   75
      Negotiate       =   -1  'True
      OleObjectBlob   =   "formaltaproductes.frx":0452
      TabIndex        =   6
      TabStop         =   0   'False
      Top             =   600
      Width           =   5280
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton alta 
         Height          =   360
         Left            =   75
         Picture         =   "formaltaproductes.frx":0E21
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton eliminar 
         Height          =   360
         Left            =   975
         Picture         =   "formaltaproductes.frx":1253
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton modificar 
         Height          =   360
         Left            =   525
         Picture         =   "formaltaproductes.frx":1565
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton sortir 
         Height          =   390
         Left            =   4815
         Picture         =   "formaltaproductes.frx":18B3
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Alta  Registres"
         Top             =   150
      ...
      Begin VB.CommandButton Command1 
         Height          =   390
         Left            =   4365
         Picture         =   "formaltaproductes.frx":1DB5
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   150
         Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "formaltaproductes"
...
tipusdato = Data1.Recordset.Fields(I).Type
...
DBGrid1.Width = formaltaproductes.Width - 285
End Sub
...
Dim dtamany As Byte
dtamany = Data1.Recordset.Fields(DBGrid1.Columns(DBGrid1.Col).DataField).Size
If dtamany = 1 Then dtamany = 2
  If Len(DBGrid1.Text) >= dtamany And KeyAscii > 46 Then KeyAscii = 0
End Sub
