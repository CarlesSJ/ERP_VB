...
Public Declare Function capGetDriverDescription Lib "avicap32" _
    Alias "capGetDriverDescriptionW" ( _
    ByVal wDriverIndex As Long, _
    ByVal lpszName As Long, _
    ByVal cbName As Long, _
    ByVal lpszVer As Long, _
...
Global lwndC As Long        ' Handle to the Capture Windows
...
End Function
Function capFileSaveDIB(ByVal lwnd As Long, ByVal szName As String) As Boolean
   capFileSaveDIB = SendMessageS(lwnd, WM_CAP_FILE_SAVEDIB, 0, szName)
End Function
...
Function capDlgVideoSource(ByVal lwnd As Long) As Boolean
   capDlgVideoSource = SendMessage(lwnd, WM_CAP_DLG_VIDEOSOURCE, True, 1)
End Function
