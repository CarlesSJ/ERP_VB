...
Global cami_llistats As String
Global buscant As Boolean
Global seleccioret As Byte
Global numop As Integer
...
Function micresmaterial(codimesuralineal As Byte, espesor As Double, tubolam As String) As String
 ...
 ' Dim r As String
  ...
  r = descripcio
End Function
Function substituirperbarra(ByVal cadena As String) As String
   Dim i As Byte
   Dim v As String
   v = atrim(cadena)
   For i = 1 To Len(v)
     If Not IsNumeric(Mid(v, i, 1)) And Mid(v, i, 1) <> "/" And Asc(Mid(v, i, 1)) > 20 Then
        v = Mid(v, 1, InStr(1, v, Mid(v, i, 1)) - 1) + "/" + Mid(v, InStr(1, v, Mid(v, i, 1)) + 1)
     End If
   Next i
   substituirperbarra = v
End Function
...
Function substituir(cadena As String, buscar As String, canviar As String) As String
   ...
   'MsgBox linia
End Function
Sub netejarreport(v As CrystalReport)

End Sub
Function estatdelabobina(v As Double, i As Double, x As Double, y As Double)

End Function
Function seccioanterior(vnumc As Double) As String
End Function
