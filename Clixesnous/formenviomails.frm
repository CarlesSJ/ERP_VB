...
Begin VB.Form formenviomails 
   ...
   Begin VB.CommandButton enviar 
      ...
      Style           =   1  'Graphical
      TabIndex        =   8
      ToolTipText     =   "Enviar per mail amb pdf del treball."
      Top             =   30
      Width           =   1440
   End
...
Private Sub enviar_Click()
  formenviomails.enviar.tag = "enviar"
  Me.Hide
End Sub
...
Dim usr As String
   usr = InputBox("Entra la contrasenya d'enviament del correu:" + Chr(10) + "(Respecteu majúscules i minúscules)", "Contrasenya")
   If usr <> "" Then
