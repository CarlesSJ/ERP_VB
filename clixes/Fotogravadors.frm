...
Begin VB.Form fFotogravadors 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton consultar 
         Height          =   360
         Left            =   2760
         Picture         =   "Fotogravadors.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   9
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton alta 
         Height          =   360
         Left            =   75
         Picture         =   "Fotogravadors.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton eliminar 
         Height          =   360
         Left            =   975
         Picture         =   "Fotogravadors.frx":0B14
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton modificar 
         Height          =   360
         Left            =   540
         Picture         =   "Fotogravadors.frx":109E
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton sortir 
         Height          =   390
         Left            =   4005
         Picture         =   "Fotogravadors.frx":1628
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Alta  Registres"
         Top             =   135
      ...
      Begin VB.CommandButton Command1 
         Height          =   390
         Left            =   3210
         Picture         =   "Fotogravadors.frx":1BB2
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   120
         Visible         =   0   'False
